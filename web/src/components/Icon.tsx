...
/**
 * Inline SVG icon set (feather-style, currentColor stroke) so the workspace
 * never depends on platform glyph coverage — several design glyphs (⚿ ◐ ⇄ 🗑 ▤)
 * render as missing-glyph "tofu" boxes on some systems. 24×24 viewBox.
 */
